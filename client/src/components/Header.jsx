...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-current'
       initial={{opacity:0}}
       animate={{opacity:1}}
      ...
      <motion.p className='text-center max-w-xl mx-auto mt-6'
       ...
       transition={{ delay:0.6, duration:0.8 }}>
        Unleast your creativity with AI. Turn your imagination into visual art in second - just type, and watch the magic happen.
      </motion.p>
