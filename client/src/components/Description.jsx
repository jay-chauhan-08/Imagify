     ...
     viewport={{ once: true }}>
      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <div>
            ...
            <p className='text-gray-600'>Simply type in a text prompt, and our cutting-edge AI will generate high quality images in seconds. From product visuals to character designs and portraits, even concept that din't yel exits can be visualized effortlessly. Powered by advances AI technology, the creative posibilities are limitless!</p>
        </div>
      </div>
